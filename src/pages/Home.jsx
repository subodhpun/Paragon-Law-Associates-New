      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center mt-16">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center bg-[#FBBF24] text-[#0F172A] px-8 py-4 rounded-md font-semibold hover:bg-[#D4AF37] transition duration-300"
            >
              Schedule Consultation
              <ChevronRight className="ml-2 w-5 h-5" />
            </Link>
            <Link
              to="/practice-areas"
              className="inline-flex items-center justify-center bg-gray-700 text-gray-200 px-8 py-4 rounded-md font-semibold hover:bg-gray-600 transition duration-300"
            >
              Our Services
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
...
// Main Home Component
const Home = () => {
  // Dummy testimonials instead of fetching
  const testimonials = [
    {
    ...
    },
    {
      ...
      content: 'Highly professional and dedicated team. Highly recommended.',
      position: 'Founder',
      company: 'Startup Inc',
      image_data: '',
    },
    {
      ...
      content: 'Their expertise made a big difference in our legal matters.',
  ...
  <Team />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-[#1E293B] p-8 rounded-lg shadow-lg text-center hover:border hover:border-[#FBBF24] transition-all duration-300">
                  <h3 className="text-xl font-semibold text-[#FBBF24] mb-4">{practice.name}</h3>
                  <p className="text-gray-300 mb-6">{practice.description}</p>
                  <Link
                    to={practice.link}
                    className="inline-flex items-center text-[#FBBF24] hover:text-[#D4AF37] transition duration-300 font-medium"
                  >
      ...
      <Slideonscroll direction="up" duration={1}>
        <div className="bg-[#1E293B] py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-[#FBBF24]">What Our Clients Say</h2>
                ...
                <Slider {...sliderSettings}>
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="px-4">
                      <div className="bg-[#0F172A] p-8 rounded-lg shadow-lg h-full">
                        {testimonial.image_data && (
                          <div className="relative w-full pb-[100%] mb-4 rounded shadow-lg overflow-hidden group">
                            <img
                              src={`data:image/png;base64,${testimonial.image_data}`}
                        ...
                        <blockquote className="italic text-lg text-white text-center mb-6">
                          "{testimonial.content}"
                        </blockquote>
                        <div className="text-center">
                          <p className="text-[#FBBF24] font-semibold">{testimonial.client_name}</p>
      ...
      <Slideonscroll direction="up" duration={1}>
        <div className="bg-[#0F172A] py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-[#FBBF24]">Why Choose Us?</h2>
              <p className="mt-4 text-lg text-gray-300 max-w-3xl mx-auto">
                Your Trusted Legal Partner. At Khusi Law Group, we prioritize your success with tailored solutions and unwavering dedication.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-[#1E293B] p-8 rounded-lg shadow-lg text-center hover:border hover:border-[#FBBF24] transition-all duration-300">
                  <h3 className="text-xl font-semibold text-[#FBBF24] mb-4">{reason.title}</h3>
      ...
      <Slideonscroll direction="up" duration={1}>
        <div className="bg-[#1E293B] py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link 
              to="/contact"
              className="inline-block bg-[#FBBF24] text-[#0F172A] px-8 py-4 rounded-lg font-semibold hover:bg-[#D4AF37] transition duration-300"
            >
              Schedule Consultation
            </Link>
          </div>
